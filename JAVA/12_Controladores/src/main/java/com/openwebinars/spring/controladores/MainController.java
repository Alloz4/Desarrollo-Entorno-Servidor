...
//	}
	...
	@GetMapping("/")
	public String welcome(@RequestParam("name") Optional<String> name,@RequestParam("apellido") Optional<String> apellido, Model model) {
		model.addAttribute("nombre", name.orElse("Marcos"));
		model.addAttribute("apellido",apellido.orElse("Alloza"));
		return "index";
	}
